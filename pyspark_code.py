...
############################### Added this line for Dynamic Frame ###############################
...
## @return: datasource0
## @inputs: []
############################### Added to extract limited region ###############################
...
############################### Added to set partitionkeys ###############################

datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://de-on-youtube-cleansed-us-east1-dev-tom/youtube/raw_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
